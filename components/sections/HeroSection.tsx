...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute right-4 top-28 z-[5] hidden opacity-40 md:block lg:right-12">
      ...
      >
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <p className="text-caption font-medium text-white/75">{brand.motto}</p>

            <h1 className="font-display text-h1 text-white">{activeSlide.headline}</h1>

            <p className="max-w-prose text-body-lg text-white/80 line-clamp-3 sm:line-clamp-none">

              {activeSlide.subtext}

            </p>

            <p className="text-caption font-medium text-cyan/90">{activeSlide.serviceTitle}</p>
            ...
            <div className="space-y-2.5 pt-2">
              ...
              <p className="text-eyebrow text-white/55">Download the Woosh app</p>
          ...
          <button
            ...
            className={cn(
              ...
              index === activeIndex
                ...
                : "bg-charcoal/60 text-white/70 backdrop-blur-sm hover:bg-charcoal/80 hover:text-white",
      ...
      <button
        ...
        className="focus-ring absolute bottom-5 left-1/2 z-10 flex min-h-[44px] -translate-x-1/2 flex-col items-center justify-center gap-1 text-caption text-white/75 transition hover:text-cyan"
